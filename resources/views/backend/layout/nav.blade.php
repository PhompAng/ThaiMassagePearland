		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li @if(Request::is('backend/booking')) class="active bg-blue-active" @endif><a href="book.html"><i class="fa fa-cubes"></i>Booking Management</a></li>
					<li @if(Request::is('backend/setting')) class="active bg-green-active" @endif><a href="setting.html"><i class="fa fa-wrench"></i>System Setting</a></li>
				</ul>
